...
def generate_all_replication_reactions(length, rconstant = 0.001, sconstant = 1E-5, dconstant = 1.0, **kwargs):
	...
	for seq in sequences:
		...
		product_coeff = [1]
		reaction_list.append( CoreClasses.Reaction(rxn_ID, reactants = reactants, reactant_coeff = reactant_coeff, products = products, product_coeff = product_coeff, constant = rconstant, prop = 'RCM') )
